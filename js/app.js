(() => {
    ...
    function headerScroll() {
        ...
        document.addEventListener("windowScroll", (function(e) {
            ...
            if (scrollTop >= startPoint) {
                ...
                if (crumb) crumb.classList.add("_crumb-scroll");
                if (headerShow) {
                ...
                if (crumb) crumb.classList.remove("_crumb-scroll");
    ...
    document.addEventListener("click", (function(e) {
        ...
        } else if (e.target.closest(".close-flyout") || !e.target.closest(".flyout") && cartMenu.classList.contains("_active") || e.target.closest(".sum__button")) if (!e.target.closest(".wish-descript__button")) {
    ...
    colorItem.forEach((function(i) {
        i.addEventListener("click", (function(e) {
            ...
            if (!i.classList.contains("_disabled")) i.classList.add("_active");
        }));
    }));
    let addWish = document.querySelector(".wish-descript__add-wish");
    if (addWish) addWish.addEventListener("click", (function() {
    ...
    window.addEventListener("click", (function(e) {
        if (e.target.closest('[data-action="plus"]') || e.target.closest('[data-action="minus"]')) {
            ...
            if (e.target.closest('[data-action="plus"]')) counter.innerText = ++counter.innerText;
            if (e.target.closest('[data-action="minus"]')) if (parseInt(counter.innerText) > 1) counter.innerText = --counter.innerText;
        }
        ...
        if (e.target.closest("[data-action]") && e.target.closest(".flyout__cart")) calcCartPrice();
    }));
    function calcCartPrice() {
        ...
        lastPrice.innerText = (totalPrice * .85).toFixed(2) + " " + "$";
    }
    calcCartPrice();
    window["FLS"] = true;
    MenuBurg();
